...
import { Building2, Users, Home, CreditCard, Plus, Search, Filter, Bell, TrendingUp, AlertTriangle } from 'lucide-react';
      ...
      <div className="container mx-auto py-6 px-4 space-y-6">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="paiements">
            <UltraCard title="Gestion des paiements" variant="glass">
              <div className="text-center py-8 text-muted-foreground">
                <CreditCard className="w-12 h-12 mx-auto mb-4 opacity-50" />
                <p>Interface de paiements en cours de développement</p>
              </div>
            </UltraCard>
          </TabsContent>
